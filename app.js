const STORAGE_KEY = "stayflow-demo-state-v1";
...
const initialState = {
  ...
  company: {
    name: "StayFlow Demo Málaga",
    city: "Málaga",
    email: "operaciones@stayflow.demo",
  },
...
const demoProfiles = {
  coordinador: {
    ...
    copy: "Vista completa para revisar el dia, asignar responsables y cerrar riesgos.",
    allowedViews: ["dashboard", "agenda", "propiedades", "tareas", "equipo", "movil", "incidencias", "configuracion"],
  ...
  limpieza: {
    ...
    copy: "Maria ve lo que tiene que ejecutar hoy, marca checklist y envia evidencias antes de cerrar una vivienda.",
  ...
  recepcion: {
    label: "Recepcion",
    member: "Luc",
    title: "Entradas y huespedes",
    subcopy: "Agenda de check-ins, notas importantes y viviendas listas para recibir.",
    copy: "Recepcion se enfoca en entradas, solicitudes especiales, llaves y estado previo al check-in.",
  ...
  propietario: {
    ...
    subcopy: "Estado de viviendas, preparacion y riesgos sin exponer la operativa interna.",
    copy: "Sirve para mostrar el potencial futuro de reportes: estado, proxima entrada y avisos relevantes.",
  ...
  if (state.activeProfile === "propietario") {
    ...
    propertyDetail.innerHTML = `
      ...
      <div class="detail-note">
        ...
        ${property.next}. ${property.status === "Lista" ? "La vivienda figura preparada para la proxima estancia." : "El equipo mantiene seguimiento operativo."}
      </div>
      <div class="detail-note">
...
function renderProfileControls() {
  ...
  profileModeTitle.textContent = state.activeProfile === "coordinador" ? "Coordinacion operativa" : `${profile.title} (${memberName})`;
